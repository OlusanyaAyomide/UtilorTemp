...
exports.getFirstDepositDay = exports.getInitialDates = void 0;
...
var getFirstDepositDay = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var transactions;
    var featureId = _b.featureId, userId = _b.userId;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4 /*yield*/, pris_client_1.default.transaction.findMany({
                    where: { userId: userId, featureId: featureId },
                    orderBy: {
                        createdAt: "asc"
                    }
                })];
            case 1:
                ...
                return [2 /*return*/, transactions[0].createdAt];
        }
    });
}); };
exports.getFirstDepositDay = getFirstDepositDay;
