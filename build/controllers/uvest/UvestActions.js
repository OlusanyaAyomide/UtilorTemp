...
exports.updateAnnualReturns = (0, catch_async_1.default)(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, mutualId, rate, mutualFundCompany;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, mutualId = _a.mutualId, rate = _a.rate;
            ...
            case 2:
                _b.sent();
                return [4 /*yield*/, pris_client_1.default.mutualFundPriceHistory.create({
                        data: {
            ...
            case 3:
                _b.sent();
                return [2 /*return*/, response_handler_1.default.sendSuccessResponse({ res: res, message: "Mutual Fund Return Rate has been updated" })];
        }
    });
}); });
exports.updateMutualFundUnitPrice = (0, catch_async_1.default)(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, mutualId, unitPrice, mutualFundCompany;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, mutualId = _a.mutualId, unitPrice = _a.unitPrice;
                return [4 /*yield*/, pris_client_1.default.mutualFundCompanies.findFirst({
                        where: {
                            id: mutualId
                        }
            ...
            case 2:
                _b.sent();
                return [2 /*return*/, response_handler_1.default.sendSuccessResponse({ res: res, message: "Mutual Fund Unit Price has been updated" })];
        }
    });
}); });
