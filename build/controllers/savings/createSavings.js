    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, response_handler_1.default.sendSuccessResponse({ res: res, code: 200, message: "ForU savings \"".concat(forUData.savingsName, "\" created successfully"), data: data })];
        }
    });
}); });
exports.createNewUAndISavings = (0, catch_async_1.default)(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var user, uAndIData, now, ending, tokenObject, partner, newUandISaving, data;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                uAndIData = req.body;
                now = new Date();
                ending = new Date(uAndIData.endingDate);
                return [4 /*yield*/, pris_client_1.default.consentToken.findFirst({
                        where: { token: uAndIData.consentToken,
                            userId: {
                                not: (_a = req.user) === null || _a === void 0 ? void 0 : _a.userId
                            },
                            expiryTime: {
                                gt: new Date()
                            } },
            ...
            case 1:
                tokenObject = _b.sent();
                if (!tokenObject) {
                    return [2 /*return*/, response_handler_1.default.sendErrorResponse({ res: res, error: "Consent Token is not valid" })];
                }
                partner = tokenObject.user;
                // Prevent from setting ending date in the past;
                if (now >= ending) {
                    return [2 /*return*/, response_handler_1.default.sendErrorResponse({ res: res, error: "Ending date must be in the future", code: 400 })];
                }
                ...
                return [4 /*yield*/, pris_client_1.default.uANDI.create({
                        data: {
