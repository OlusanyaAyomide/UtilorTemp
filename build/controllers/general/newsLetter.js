    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, pris_client_1.default.newsLetter.findFirst({
                        where: { email: email }
                    })];
            case 1:
...
exports.retrieveAllSubscribers = (0, catch_async_1.default)(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var allEmails;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, pris_client_1.default.newsLetter.findMany()];
            case 1:
                allEmails = _a.sent();
                return [2 /*return*/, response_handler_1.default.sendSuccessResponse({ res: res, data: allEmails })];
        }
    });
}); });
exports.unSubscribeFromNewsLetter = (0, catch_async_1.default)(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var email, isPresent;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                isPresent = _a.sent();
                if (!isPresent) {
                    return [2 /*return*/, response_handler_1.default.sendErrorResponse({ res: res, error: "Email Not Subscribed" })];
                }
                return [4 /*yield*/, pris_client_1.default.newsLetter.delete({
                        where: { id: isPresent.id }
                    })];
            case 2:
                _a.sent();
                return [2 /*return*/, response_handler_1.default.sendSuccessResponse({ res: res, message: "Email unsubscribed succesffully" })];
        }
    });
}); });
