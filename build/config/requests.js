...
exports.generatePaymentLink = void 0;
var flutterwaveinterceptor_1 = __importDefault(require("./flutterwaveinterceptor"));
var generatePaymentLink = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, flutterwaveinterceptor_1.default.post("/payments", body)];
            case 2:
                response = _a.sent();
                if (response.data) {
